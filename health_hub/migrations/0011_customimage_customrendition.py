...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('health_hub', '0010_alter_articlepage_body'),
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ForeignKey(editable=False, on_delete=django.db.models.deletion.CASCADE, related_name='renditions', to='health_hub.customimage')),
            ],
            options={
